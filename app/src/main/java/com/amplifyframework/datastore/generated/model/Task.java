...
public final class Task implements Model {
  ...
  private Task(String id, String name, String description, TaskState state, Temporal.Date dueDate) {
    this.id = id;
    this.name = name;
  ...
  public static class Builder implements NameStep, BuildStep {
    ...
    private Builder(String id, String name, String description, TaskState state, Temporal.Date dueDate) {
      this.id = id;
      this.name = name;
      this.description = description;
      this.state = state;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, TaskState state, Temporal.Date dueDate) {
      super(id, name, description, state, dueDate);
      Objects.requireNonNull(name);
    }
